...
public class ProjectJava {
    ...
    public static void main(String[] args) {
        ...
        // setar valores para manutenção motores eletrico
        manutencaoReparo01.setNomeProduto("Manutenção de Motores Elétricos");
        manutencaoReparo01.setDescricaoManutencao("Descrição: Realize inspeções regulares nos rolamentos, verificando ruídos anormais ou aquecimento excessivo. Lubrifique os rolamentos conforme as instruções do fabricante e substitua-os se necessário. Verifique a conexão dos terminais elétricos e a presença de sinais de desgaste ou corrosão.");
        manutencaoReparo01.setExemploPratico("Exemplo Prático: Para motores WEG, recomenda-se a realização de manutenção preventiva a cada 1.000 horas de operação, incluindo a verificação do alinhamento do motor e o teste de resistência do isolamento.");


        // setar valores para Reparo de Transformadores
        manutencaoReparo02.setNomeProduto("Reparo de Transformadores");
        manutencaoReparo02.setDescricaoManutencao("Descrição: Quando realizar reparos em transformadores WEG, sempre faça uma análise cuidadosa da situação de cada componente, como bobinas e buchas. Caso haja falha nas buchas ou nos isoladores, substitua-os imediatamente. Em caso de curto-circuito no interior do transformador, realize testes de resistência de isolamento e verifique o nível de óleo.");
        manutencaoReparo02.setExemploPratico("Exemplo Prático: Se um transformador WEG apresentar aquecimento excessivo, além de verificar o nível de óleo, examine o radiador e limpe as ventoinhas para garantir uma boa dissipação de calor.");


        // setar valores para funcionalidade de motor
        testeDiagnostico1.setNomeProduto("Testes de Funcionamento de Motores");
        testeDiagnostico1.setDescricaoDiagnostico("Descrição: Para garantir que o motor WEG está operando corretamente, execute testes de partida em vazio, monitorando a corrente elétrica e a rotação. Após a operação, verifique a temperatura do motor e as vibrações para identificar possíveis falhas mecânicas.");
        testeDiagnostico1.setexemploPratico("Exemplo Prático: Durante os testes de carga, monitore a eficiência do motor e se a corrente está dentro dos parâmetros especificados pelo fabricante para evitar danos ao equipamento");


        // setar valores para Diagnóstico de Falhas


        testeDiagnostico2.setNomeProduto("Diagnóstico de Falhas em Sistemas de Automação");
        testeDiagnostico2.setDescricaoDiagnostico("Descrição: No diagnóstico de falhas em sistemas de automação da WEG, como controladores e inversores de frequência, utilize ferramentas de diagnóstico de comunicação como modbus ou ethernet para verificar possíveis falhas de comunicação. Revise os logs de erros e teste os sensores e atuadores para garantir que todos os sistemas estão funcionando corretamente.");
        testeDiagnostico2.setexemploPratico("Exemplo Prático: Para sistemas de automação WEG com inversores de frequência, execute um teste de carga variável para identificar falhas em processos de controle de velocidade e torque.");




        // setar valores para manual de conduta
        manualCondutaSetorial01.setNomeSetor("Conduta no Setor de Montagem");
        manualCondutaSetorial01.setCondutaEsperada("No setor de montagem, os colaboradores devem seguir rigorosamente os procedimentos de segurança e as normas de qualidade da WEG. Devem garantir que as ferramentas e equipamentos estejam sempre em boas condições, realizando inspeções periódicas e manutenções preventivas.");
        manualCondutaSetorial01.setObservacoes("Ao montar motores elétricos WEG, é fundamental verificar se as peças estão corretamente alinhadas e se todas as conexões elétricas estão firmemente apertadas, prevenindo falhas e retrabalho.");


        // setar valores para Procedimentos Operacionais
        manualCondutaSetorial2.setNomeSetor("Procedimentos Operacionais no Setor de Manutenção");
        manualCondutaSetorial2.setCondutaEsperada("Conduta Esperada:\n" +
        ...
        manualCondutaSetorial2.setObservacoes(" Durante a manutenção de um inversor de frequência WEG, o técnico deve inspecionar cuidadosamente os componentes eletrônicos internos (como resistores e capacitores) e realizar testes de isolamento, assegurando a integridade e segurança do equipamento. ");
